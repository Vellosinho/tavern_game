  ...
  Widget build(BuildContext context) {
      return BaseMap(
        ...
        components: [
          ...
          ...tree(position: Vector2(tileSize * 35, tileSize * 12), type: TreeType.pine1),
          ...
          ...tree(position: Vector2(tileSize * 54.5, tileSize * 3.5), type: TreeType.pine1),
          ...
          ...tree(position: Vector2(tileSize * 53, tileSize * 8.75), type: TreeType.pine2),
          ...
          ...tree(position: Vector2(tileSize * 55, tileSize * 18), type: TreeType.pine1),
          ...
          ...bush(position: Vector2(tileSize * 27.25, tileSize * 30), type: BushType.bush1),
          ...
          ...bush(position: Vector2(tileSize * 27.25, tileSize * 16.75), type: BushType.bush1),
          ...
          ...bush(position: Vector2(tileSize * 49.5, tileSize * 30.5), type: BushType.bush2),
