...
class SheppardNPC extends BaseNPC {
  @override
  ...
  SheppardNPC({
    ...
    required this.controller,
          ...
          defaultAnimations: NeutralSheppardNPCSprites().defaultAnimations,
          actions: [
            // BaseAction(
            //   position: PointsOfInterest.strawberryBush,
            //   newAnimation: NeutralSheppardNPCSprites().farmerGathering,
            // ),
            // BaseAction(
            //   position: PointsOfInterest.readingTree,
            //   newAnimation: NeutralSheppardNPCSprites().neutralFarmerReading,
            // ),
            // BaseAction(
            //   position: PointsOfInterest.goddessStatue,
            //   newAnimation: NeutralSheppardNPCSprites().neutralFarmerPraying,
            // ),
          ],
