        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(height: 48, width: (((playerOneController.playerLife < 0) ? 0 : playerOneController.playerLife) * 3.52), child: DecoratedBox(decoration: BoxDecoration(color: Color(0xffff0000))))),
            ...
            //    ],
             ...
             Positioned(
              ...
              child: AnimatedRotation(
                ...
                turns: ((playerOneController.playerTemperature + 10) / 60) - 0.5,
                child: SizedBox(height: 60, width: 3,
                 child: Column(
              children: [
                 SizedBox(height: 16, width: 3,child: DecoratedBox( decoration: BoxDecoration(color: Colors.black),)),
               ],
